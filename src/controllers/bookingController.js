   ...
   createBooking: async (req, res) => {
       try {
           ...
           if (req.body.journey.type === 'roundTrip') {
               // Pour un aller-retour, créez une seule réservation avec des prix distincts pour chaque trajet
               const outboundPrice = {
                   sharedPrice: req.body.journey.outbound.price?.sharedPrice || req.body.price.sharedPrice / 2,
                   privatePrice: req.body.journey.outbound.price?.privatePrice || req.body.price.privatePrice / 2
               };
               
               const inboundPrice = {
                   sharedPrice: req.body.journey.inbound.price?.sharedPrice || req.body.price.sharedPrice / 2,
                   privatePrice: req.body.journey.inbound.price?.privatePrice || req.body.price.privatePrice / 2
               };
               ...
               const bookingData = {
                   ...
                   journey: {
                       type: 'roundTrip',
                       outbound: {
                           ...req.body.journey.outbound,
                           price: outboundPrice
                       },
                       inbound: {
                           ...req.body.journey.inbound,
                           price: inboundPrice
                       }
                   },
