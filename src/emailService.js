      ...
      completeBooking = {
        ...
        journey: {
          ...
          outbound: {
            ...
            // Assurez-vous que les prix de l'aller sont bien présents
            price: outboundBooking.journey.outbound.price || {
              sharedPrice: outboundBooking.price.sharedPrice / 2,
              privatePrice: outboundBooking.price.privatePrice / 2
            }
          },
          inbound: {
            ...inboundBooking.journey.inbound,
            // Assurez-vous que les prix du retour sont bien présents
            price: inboundBooking.journey.inbound.price || {
              sharedPrice: inboundBooking.price.sharedPrice / 2,
              privatePrice: inboundBooking.price.privatePrice / 2
            }
          }
        }
      };
