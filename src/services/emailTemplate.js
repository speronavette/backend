...
cconst generateAdminNotificationTemplate = (booking) => {
  const speroColor = 'rgb(232, 138, 120)';
              ...
              <div style="margin-top: 15px; padding-top: 10px; border-top: 1px dashed ${speroColor};">
                ...
                <div style="margin-top: 5px; font-size: 12px;">
                  <p><strong>Prix aller:</strong> ${booking.serviceType === 'private' 
                    ? (booking.journey.outbound.price?.privatePrice || booking.price.privatePrice/2) 
                    : (booking.journey.outbound.price?.sharedPrice || booking.price.sharedPrice/2)} €</p>
                  <p><strong>Prix retour:</strong> ${booking.serviceType === 'private' 
                    ? (booking.journey.inbound.price?.privatePrice || booking.price.privatePrice/2) 
                    : (booking.journey.inbound.price?.sharedPrice || booking.price.sharedPrice/2)} €</p>
                </div>
              </div>
            ` : `
