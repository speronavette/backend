...
const generateEmailTemplate = (booking, template = 'confirmed') => {
  ...
  * {
  ...
  .content-section {
    ...
    margin: 0 0 12px 0; /* Réduit la marge */
    padding: 0;
    text-align: center;
    overflow: hidden;
    width: 100%;
  ...
  .section-title {
    ...
    font-size: 16px; /* Taille de police pour les titres de section */
  }
  ...
  .info-label {
    color: ${speroColor};
    margin-top: 6px; /* Réduit la marge */
    font-size: 13px; /* Taille de police pour les étiquettes */
  }
  
  .info-value {
    font-size: 13px; /* Taille de police pour les valeurs */
  }
  ...
  .journey-title {
    ...
    text-align: center;
    background-color: rgba(232, 138, 120, 0.1);
    font-size: 15px; /* Taille de police pour les titres de trajet */
  }
  ...
  .header h1 {
    font-size: 18px; /* Taille de police pour le titre principal */
    margin: 0;
  }
  
  .header p {
    font-size: 14px; /* Taille de police pour le sous-titre */
    margin: 3px 0;
  }
  ...
  .review-button {
    ...
    font-size: 14px; /* Taille de police pour le bouton */
  }
  ...
  .options-list {
    font-size: 12px; /* Taille de police pour les listes d'options */
    margin-left: 15px;
    padding-left: 5px;
  }
  
  .payment-info {
    font-size: 12px; /* Taille de police pour les infos de paiement */
    color: #666;
    margin-top: 8px;
  }
`;
