...
const stripePreAuthRoutes = require('./src/routes/stripe-preauth');
...
// ✅ NOUVEAU : Routes Stripe pré-autorisation (fichier séparé)
app.use('/api/stripe', stripePreAuthRoutes);
